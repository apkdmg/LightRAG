...
const LoginPage = () => {
  ...
  const handleSSOLogin = async () => {
    try {
      ...
      // Redirect to the Keycloak login page; the callback is handled by the
    ...
    // On success we are redirecting, so setSSOLoading(false) is intentionally
    // not called here.
  }
    ...
    <div className="flex h-screen w-screen items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <Card className="w-full max-w-[480px] shadow-lg mx-4">
        ...
        <CardContent className="px-8 pb-8">
          {/* SSO button — shown above the form when OAuth2 is enabled */}
          {oauth2Enabled && (
            <>
              <Button
                type="button"
